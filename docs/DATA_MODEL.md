...
- `shop.json`: mnożnik ceny receptur, boostery i dekoracje.
...
`pity_counter`, `active_blessings`, `offline_pending`, `market`, `settings`,
`stats`, `last_save_unix` i `save_version`.
...
growth ulepszeń 1,15 i gacha rates są zgodne z GDD.
